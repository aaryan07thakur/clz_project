    ...
    <?php
        ...
        foreach($datas as $data){
            ...
            <div class="row mx-1">
				...
				<span class="col-md-11">: <?php echo $data['c_name']?></span>
			</div>
            <div class="row mx-1">
                <span class="col-md-1 ">Email</span>
				<span class="col-md-11">: <?php echo $data['c_email']?></span>
			</div>
            <div class="row mx-1">
                <span class="col-md-1 ">Address</span>
				<span class="col-md-11">: <?php echo $data['c_address']?></span>
			</div>
            <div class="row mx-1">
                <span class="col-md-1 ">Contact </span>
				<span class="col-md-11">: <?php echo $data['c_contact']?></span>
			</div>
            <div class="row mx-1">
                <span class="col-md-1 ">Status</span>
				<span class="col-md-11">: <?php echo $data['account_status']?></span>
			</div>
            <td><a href="index.php?m=profile&p=change&id=<?php echo $data['c_id']?>" class="btn btn-info mt-3 mb-3 mb-1 mx-3" role="button">Edit Profile</a>
            <?php
        }
    ?>
</div>
