...
<?php
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST") {
        ...
        $front_path="../../img/owner/credential/".$front;
        $back_path="../../img/owner/credential/".$back;
        ...
        if(preg_match("!image!",$_FILES['image1']['type']) && preg_match("!image!",$_FILES['image2']['type'])){
            if(copy($_FILES['image1']['tmp_name'],$front_path) && copy($_FILES['image2']['tmp_name'],$back_path)){
                $add= $credential->addOwnerCredential($credential_name,$front_path,$back_path,$o_id);
...
?>
<div>
    <p class="h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Add Credential</p>
    <hr/>
